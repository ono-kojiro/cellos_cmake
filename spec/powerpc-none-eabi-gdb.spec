%define target powerpc-none-eabi
...
Patch0 :    0001-gdb-fix_multiple_defs.patch
...
CFLAGS="$RPM_OPT_FLAGS" ../gdb-%{version}/configure --prefix=%{_prefix} \
	...
	--with-python=/usr/bin/python3 --without-doc --with-xml --with-expat 
	
	# --without-guile --enable-sim-stdio --enable-sim-powerpc
make %{?_smp_mflags}
